...
namespace ConferenceManagerExampleApp.Data.Migrations
{
    ...
    [Migration("20191007020228_AddUserTimeSlot")]
    partial class AddUserTimeSlot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConferenceManagerExampleApp.Models.Domains.UserTimeSlotModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime>("TimeSlotModelEndTime")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("TimeSlotModelStartTime")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TimeSlotModelStartTime", "TimeSlotModelEndTime");

                    b.ToTable("UserTimeSlot");
                });
            ...
            modelBuilder.Entity("ConferenceManagerExampleApp.Models.Domains.UserTimeSlotModel", b =>
                {
                    ...
                    b.HasOne("ConferenceManagerExampleApp.Models.Domains.TimeSlotModel", "TimeSlotModel")
                        .WithMany()
                        .HasForeignKey("TimeSlotModelStartTime", "TimeSlotModelEndTime")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
